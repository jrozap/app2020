Public Class ActPresAPO
    ...
    Private Sub ActPresAPO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'MasterAPVDataSet5.PartObr' table. You can move, or remove it, as needed.
        Me.PartObrTableAdapter.Fill(Me.MasterAPVDataSet5.PartObr)
        ...
        For idx = 0 To (nRecords - 1)
            CodObrA = CStr(ObrasAPO.Tables("obras").Rows(idx).Item("cod-obr"))
            ObrasCB.Items.Insert(idx, CodObrA)
        Next
    ...
    Private Sub ObrasCB_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ObrasCB.SelectedIndexChanged
        ...
        CodObrA = ObrasAPO.Tables("obras").Rows(elem).Item("cod-obr")
        ...
        cmdSQLPart = "SELECT * FROM AnPartidas ORDER BY [num-par-apu]"
        ...
        ParGrdE = CInt(PartGridP.CurrentCell.Value - 1)
        ...
        End If
        If DSetPartidas.Tables("PartO").Rows(ParGrdE).Item(10).Equals(DBNull.Value) Then
            pTexto = ""
        Else
            pTexto = CStr(DSetPartidas.Tables("PartO").Rows(ParGrdE).Item(10))
        End If
    ...
    Private Sub Button8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CodObrE = Me.ObrasCB.SelectedIndex
        DatosObr.Show()
    End Sub
