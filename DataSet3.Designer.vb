...
Namespace DataSet3TableAdapters
    ...
    Partial Public Class MatCompDDTableAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DataSet3.MatCompDDDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DataSet3.MatCompDDDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DataSet3.MatCompDDDataTable = New DataSet3.MatCompDDDataTable
